...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:linear-gradient(160deg,#06001a,#0a0030,#04000f);border:1px solid rgba(139,92,246,0.4);border-radius:16px;overflow:hidden">
  ...
  <tr><td style="padding:16px 24px;border-bottom:1px solid rgba(139,92,246,0.15)">
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr><td style="padding:5px 0;color:rgba(139,92,246,0.5);font-size:9px;letter-spacing:1px;text-transform:uppercase;width:25%;vertical-align:top">EMAIL</td><td style="padding:5px 0;color:#e2e8f0;font-size:12px;font-weight:600">${reg.email}</td></tr>
      <tr><td style="padding:5px 0;color:rgba(139,92,246,0.5);font-size:9px;letter-spacing:1px;text-transform:uppercase;width:25%;vertical-align:top">PHONE</td><td style="padding:5px 0;color:#e2e8f0;font-size:12px;font-weight:600">${reg.phone}</td></tr>
      <tr><td style="padding:5px 0;color:rgba(139,92,246,0.5);font-size:9px;letter-spacing:1px;text-transform:uppercase;width:25%;vertical-align:top">BRANCH</td><td style="padding:5px 0;color:#e2e8f0;font-size:12px;font-weight:600">${reg.branch}</td></tr>
      <tr><td style="padding:5px 0;color:rgba(139,92,246,0.5);font-size:9px;letter-spacing:1px;text-transform:uppercase;width:25%;vertical-align:top">COLLEGE</td><td style="padding:5px 0;color:#e2e8f0;font-size:12px;font-weight:600">${reg.collegeName}</td></tr>
      <tr><td style="padding:5px 0;color:rgba(139,92,246,0.5);font-size:9px;letter-spacing:1px;text-transform:uppercase;width:25%;vertical-align:top">TEAM</td><td style="padding:5px 0;color:#e2e8f0;font-size:12px;font-weight:600">${reg.teamName}</td></tr>
      <tr><td style="padding:5px 0;color:rgba(139,92,246,0.5);font-size:9px;letter-spacing:1px;text-transform:uppercase;width:25%;vertical-align:top">MEMBERS</td><td style="padding:5px 0;color:#e2e8f0;font-size:12px;font-weight:600">${reg.teamMembers.length ? reg.teamMembers.join(', ') : reg.name}</td></tr>
    </table>
  </td></tr>
  <tr><td style="padding:20px 24px;text-align:center;border-bottom:1px solid rgba(139,92,246,0.15)">
    ...
    <p style="color:rgba(239,68,68,0.7);font-size:10px;margin:10px 0 0">Do not share this QR code with anyone</p>
  </td></tr>
  <tr><td style="padding:16px 24px;border-bottom:1px solid rgba(139,92,246,0.15)">
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td style="text-align:center;padding:8px">
          <p style="font-size:20px;margin:0 0 4px">Date</p>
        ...
        <td style="text-align:center;padding:8px;background:rgba(34,211,238,0.06);border-radius:8px">
          <p style="font-size:20px;margin:0 0 4px">Venue</p>
        ...
        <td style="text-align:center;padding:8px">
          <p style="font-size:20px;margin:0 0 4px">Time</p>
  ...
  <tr><td style="padding:16px 24px;border-bottom:1px solid rgba(139,92,246,0.15)">
    ...
    <table cellpadding="0" cellspacing="0">
      <tr><td style="padding:3px 0;color:#e2e8f0;font-size:12px">&bull; Bring this email / QR code to the venue</td></tr>
      <tr><td style="padding:3px 0;color:#e2e8f0;font-size:12px">&bull; Report by 9:00 AM on 23 April 2026</td></tr>
      <tr><td style="padding:3px 0;color:#e2e8f0;font-size:12px">&bull; Carry your college ID card</td></tr>
      <tr><td style="padding:3px 0;color:#e2e8f0;font-size:12px">&bull; Bring your laptop with your game project</td></tr>
      <tr><td style="padding:3px 0;color:#e2e8f0;font-size:12px">&bull; Do NOT share your QR code with others</td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="background:linear-gradient(90deg,#22d3ee,#3b82f6,#a855f7);height:4px;font-size:0">&nbsp;</td></tr>
      ...
      await sendMailWithRetry(transporter, {
        ...
        html: `<div style="font-family:Arial,sans-serif;background:#020010;color:#e2e8f0;padding:40px;max-width:600px;margin:0 auto;border-radius:16px;border:1px solid rgba(239,68,68,0.3)">
          ...
          <p style="color:rgba(139,92,246,0.5);font-size:11px;text-align:center">&copy; 2026 Game-o-thon 2K26 &middot; ZIBACAR</p>
        </div>`,
      });
